...
Min3PA2017$X3PS <- factor(Min3PA2017$X3PS, levels = c("average", "good", "excellent"))

Min3PA2017 <- subset(clplayerdata2, X3PA >= 100 & Year == 1980)
Min3PA2017 = Min3PA2017  %>%
  mutate(X3PS =
           ifelse(Min3PA2017$X3P.<=.1, "terrible", 
                  ifelse(Min3PA2017$X3P.<=.2 & Min3PA2017$X3P. >= .1,"poor" , 
...
X3Pa17 = subset(clplayerdata2, Tm == 'HOU' & Year ==2017 )
